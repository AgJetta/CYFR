...
class SignalGenerator:
    @staticmethod
    def get_timeseries(start_time, duration, sampling_rate):
        t = np.linspace(start_time, start_time + duration, int(duration * sampling_rate) + 1)
        return t
    ...
    @staticmethod
    def generate_sinusoidal(amplitude, signal_frequency, start_time, duration, sampling_rate=1000):
        t = SignalGenerator.get_timeseries(start_time, duration, sampling_rate)
