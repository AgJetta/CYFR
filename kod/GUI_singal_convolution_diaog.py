...
class SignalConvolutionDialog(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle(SIGNAL_CONVOLUTION_DIALOG_TITLE)
        ...
        convolution_btn = QPushButton(PERFORM_CONVOLUTION)
        convolution_btn.clicked.connect(self.perform_convolution)
